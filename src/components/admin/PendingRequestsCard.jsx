...
export default function PendingRequestsCard({ requests }) {
  return (
    <section className="rounded-2xl border border-white/10 bg-slate-800/70 p-6 shadow-xl shadow-slate-950/25">
      ...
      <button type="button" className="mt-4 w-full rounded-xl border border-white/10 bg-slate-900/50 py-2.5 text-sm font-medium text-slate-300 transition hover:bg-slate-700/70">
        {requests.moreLabel}
      </button>
    </section>
  );
